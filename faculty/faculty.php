...
<link rel="stylesheet" type="text/css" href="<?php echo $includeurl; ?>dirshow/styles.css" />
...
<div align="center">
<form action="./texteditor.php" method="post" target="_blank">
<p>
Enter the file name to Compile
<input type="text"  name="File_open" maxlength="30" >

<input type="submit" value="open" name="facOpen">
</p>
</div>
